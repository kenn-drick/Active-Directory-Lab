# 07 - Access‑Based Enumeration (ABE)
...
![Department Folder Share Permissions](./Images/departments_share_permissions.png)
...
![Deparments Folder NTFS Permissions](./Images/departments_ntfs_permissions.png)
...
![Accounting subfolder NTFS permissions](./Images/depart_subf_ntfs_permissions.png)
...
![Enable ABE](../Images/enable_ABE.png)
4. Go to the **Settings** tab.
5. Check **Enable access‑based enumeration**.
![Enable ABE](../Images/enable_ABE2.png)
6. Click **OK**.
...
![Validate ABE](../Images/check_ABE.png)